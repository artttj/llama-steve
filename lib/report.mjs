...
export function renderReport(r, { mode = 'report', v = '' } = {}) {
  ...
  const finalBlock = mode === 'landing'
    ? `<h2>Stop adding. Start cutting.</h2>
       ...
       <div class="install" style="margin-top:12px"><span>/plugin install <b class="ga">llama-steve</b></span><span class="copy">COPY</span></div>`
...
<meta property="og:image" content="https://sonto.space/steve/assets/og-card.png">
<meta property="og:image:secure_url" content="https://sonto.space/steve/assets/og-card.png">
...
<meta name="twitter:image" content="https://sonto.space/steve/assets/og-card.png">
