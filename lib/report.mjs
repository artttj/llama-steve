...
<nav><div class="wrap">
  ...
  <button class="theme-btn" id="themeBtn" type="button" aria-label="Toggle theme"><span class="moon">☾</span><span class="sun">☀</span></button>
  ${navCta}
</div></nav>
...
<header>
  ...
  <p class="lede">Point him at your product. He runs a 10× teardown, kills the noise, and hands back the few moves actually worth building.</p>
...
<section class="final" id="get"><div class="wrap">${finalBlock}</div>
  <footer><div class="fl"><a href="https://github.com/artttj/llama-steve">GitHub</a><a href="#model">The mind</a><a href="https://github.com/artttj/llama-smith">llama-smith</a><a href="https://sonto.space/steve">Live demo</a></div>
