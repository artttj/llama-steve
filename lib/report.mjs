...
<header>
  ...
  <h1>Your roadmap has <span id="roadmapCount" data-count>1,000</span> ideas.<span class="sub"><em class="ed-name">Llama Steve</em> ships 3.</span></h1>
...
<section class="verdict" id="verdict"><div class="wrap">
  <p class="label" style="text-align:center;margin-bottom:34px">The verdict — in the Llama Steve voice, run through /humanizer</p>
...
<section class="final" id="get"><div class="wrap">${finalBlock}</div>
  <footer><div class="fl"><a href="https://github.com/artttj/llama-steve">GitHub</a><a href="#model">The taste</a><a href="https://github.com/artttj/llama-smith">llama-smith</a><a href="https://sonto.space/steve">Live demo</a></div>
