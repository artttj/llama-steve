...
<section class="taste" id="model"><div class="wrap"><div class="taste-card">
  <div class="taste-body">
    <p class="taste-kicker">// not a prompt. a mental model.</p>
    <h2 class="taste-h">Llama Steve isn't a one-line persona. <em>It's the operating system that cut 350 products down to 10.</em></h2>
    <p class="taste-p">Most "act like Steve Jobs" prompts are a sentence and a vibe. Llama Steve was distilled from biographies, interviews, keynotes, and primary sources into mental models, heuristics, and a voice DNA. Not a costume — a product judgment engine built around focus, taste, and ruthless subtraction.</p>
  </div>
  ...
  <div class="mm-grid">
    <div class="mm"><div class="mm-top"><span class="mm-i">01</span><h4 class="mm-name">Focus = saying no</h4></div><p class="mm-d">Focus isn't picking the one thing to do. It's saying no to the hundred good ideas you won't.</p></div>
    <div class="mm"><div class="mm-top"><span class="mm-i">02</span><h4 class="mm-name">The whole widget</h4></div><p class="mm-d">If you're serious about the software, build the hardware too. Hand off a piece and you've handed off the experience.</p></div>
    <div class="mm"><div class="mm-top"><span class="mm-i">03</span><h4 class="mm-name">Connecting the dots</h4></div><p class="mm-d">You can't connect the dots looking forward, only looking back. So follow your gut and keep going.</p></div>
    <div class="mm"><div class="mm-top"><span class="mm-i">04</span><h4 class="mm-name">Death as the filter</h4></div><p class="mm-d">If today were your last day, would you still do what you're about to? Too many no's in a row and something has to change.</p></div>
    <div class="mm"><div class="mm-top"><span class="mm-i">05</span><h4 class="mm-name">Reality distortion field</h4></div><p class="mm-d">Get people to believe in the impossible, and it stops being impossible.</p></div>
    <div class="mm"><div class="mm-top"><span class="mm-i">06</span><h4 class="mm-name">Technology × liberal arts</h4></div><p class="mm-d">Technology on its own isn't enough. Marry it to the humanities and you make something that sings.</p></div>
  </div>
