...
<header>
  ...
  <p class="lede">Point him at your product. He finds every move that could make it better, cuts the noise, and hands back the few actually worth building.</p>
...
<section id="output"><div class="wrap">
  <div class="out-head">
    ...
    <p class="sec-sub">He finds every change that could genuinely make the product better, then cuts the ones that aren't worth it. What's left is ranked by payoff against effort. More 🔥 means a bigger win.</p>
  </div>
  <div class="terminal">
