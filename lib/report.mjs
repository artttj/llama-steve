...
<header>
  ...
  <h1>Your roadmap has 1,000 features.<span class="sub">He ships 3.</span></h1>
  <p class="lede">Point him at your product. He runs a 10× teardown, says no to 997 good ideas, and hands back the handful worth your weekend — with a verdict you'll actually feel.</p>
  ...
  <div class="portrait-stage">
    ...
    <span class="portrait-tag">"Real artists ship. Everyone else adds a settings page."</span>
  </div>
</header>
...
<section class="final" id="get"><div class="wrap">${finalBlock}</div>
  <footer><div class="fl"><a href="#">GitHub</a><a href="#">The skill</a><a href="#">llama-smith</a><a href="#">Live demo</a></div>
  Built on the llama-smith engine · a mental model, not a costume · 2026</footer>
</section>
</body>
</html>`
}
